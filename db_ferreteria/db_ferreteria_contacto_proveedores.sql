...
CREATE TABLE `contacto_proveedores` (
  `id_contacto_pro` int NOT NULL AUTO_INCREMENT,
  `id_proveedor` int NOT NULL,
  `calle` varchar(50) NOT NULL,
  `barrio` varchar(50) NOT NULL,
  `telefono` int NOT NULL,
  `email` varchar(50) NOT NULL,
  PRIMARY KEY (`id_contacto_pro`),
  KEY `id_proveedor` (`id_proveedor`),
  CONSTRAINT `contacto_proveedores_ibfk_1` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`)
